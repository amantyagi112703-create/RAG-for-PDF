...
import { CollectionDeleteManyError, CollectionFindCursor, CollectionInsertManyError, CollectionUpdateManyError, TooManyDocumentsToCountError, } from '../../documents/index.js';
...
import { CollectionFindAndRerankCursor } from '../../documents/collections/cursors/rerank-cursor.js';
import { InternalLogger } from '../../lib/logging/internal-logger.js';
const jbi = JBI;
export class Collection extends HierarchicalLogger {
        ...
        __classPrivateFieldSet(this, _Collection_httpClient, httpClient.forTableSlashCollectionOrWhateverWeWouldCallTheUnionOfTheseTypes(this, opts, hack), "f");
        __classPrivateFieldSet(this, _Collection_commands, new CommandImpls(this, __classPrivateFieldGet(this, _Collection_httpClient, "f"), new CollSerDes(CollSerDes.cfg.parse(opts?.serdes))), "f");
        ...
        return __classPrivateFieldGet(this, _Collection_commands, "f").insertMany(documents, options, CollectionInsertManyError);
    }
        async updateOne(filter, update, options) {
        return __classPrivateFieldGet(this, _Collection_commands, "f").updateOne(filter, update, options);
    }
        async updateMany(filter, update, options) {
        return __classPrivateFieldGet(this, _Collection_commands, "f").updateMany(filter, update, options, (e, result) => new CollectionUpdateManyError(e, result));
    }
        ...
        return __classPrivateFieldGet(this, _Collection_commands, "f").deleteMany(filter, options, (e, result) => new CollectionDeleteManyError(e, result));
    }
        find(filter, options) {
        return __classPrivateFieldGet(this, _Collection_commands, "f").find(filter, options, CollectionFindCursor);
    }
        findAndRerank(filter, options) {
        return __classPrivateFieldGet(this, _Collection_commands, "f").findAndRerank(filter, options, CollectionFindAndRerankCursor);
    }
        async findOne(filter, options) {
        return __classPrivateFieldGet(this, _Collection_commands, "f").findOne(filter, options);
    }
        async distinct(key, filter, options) {
        return __classPrivateFieldGet(this, _Collection_commands, "f").distinct(key, filter, options, CollectionFindCursor, { _id: 0 });
    }
        async countDocuments(filter, upperBound, options) {
        return __classPrivateFieldGet(this, _Collection_commands, "f").countDocuments(filter, upperBound, options, TooManyDocumentsToCountError);
    }
        ...
        const resp = await __classPrivateFieldGet(this, _Collection_db, "f").listCollections({ ...options, keyspace: this.keyspace });
