...
exports.DataAPIDurationBuilder = exports.duration = exports.DataAPIDuration = void 0;
...
const utils_js_3 = require("../../lib/api/ser-des/utils.js");
class DataAPIDuration {
        [constants_js_2.$SerializeForCollection]() {
        throw (0, utils_js_3.mkTypeUnsupportedForCollectionsError)('DataAPIDuration', '_duration', [
    ...
    constructor(i1, i2, i3) {
        ...
        switch (arguments.length) {
            ...
            case 2:
                if (typeof i1 !== 'string') {
                    throw (0, utils_js_1.mkInvArgsError)('DataAPIDuration', [['duration', 'string']], i1);
                }
            ...
            case 3:
                if (typeof i1 !== 'number' || typeof i2 !== 'number' || (typeof i3 !== 'number' && typeof i3 !== 'bigint')) {
                    throw (0, utils_js_1.mkInvArgsError)('new DataAPIDuration', [['months', 'number'], ['days', 'number'], ['nanoseconds', 'number | bigint']], i1, i2, i3);
                }
...
exports.duration = Object.assign((...params) => (params[0] instanceof DataAPIDuration) ? params[0] : new DataAPIDuration(...params), { builder: DataAPIDuration.builder });
class DataAPIDurationBuilder {
...
exports.DataAPIDurationBuilder = DataAPIDurationBuilder;
...
const parseDataAPIDuration = (str, negative) => {
    ...
    while (index < str.length) {
        ...
        index += (0, utils_js_2.numDigits)(num);
