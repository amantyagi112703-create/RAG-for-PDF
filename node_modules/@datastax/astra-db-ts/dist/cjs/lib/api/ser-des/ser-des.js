...
class SerDes {
    ...
    serialize(obj, target = ctx_js_1.SerDesTarget.Record) {
        ...
        const ctx = this.adaptSerCtx(this._mkCtx(obj, target, {
            mutatingInPlace: this._cfg.mutateInPlace === true && target === ctx_js_1.SerDesTarget.Record, // prevents some potential footguns when reusing filter/sort/etc. objects
