 ...
 * @public
 */
export declare interface AddFieldOperation {
    /**
 ...
 * @public
 */
export declare interface AlterTypeOperations<Schema extends SomeRow> {
    /**
 ...
 * @public
 */
export declare interface AlterTypeOptions<Schema extends SomeRow> extends CommandOptions<{
    timeout: 'tableAdminTimeoutMs';
}>, WithKeyspace {
    /**
 ...
 * @public
 */
export declare type AstraDatabaseStatus = LitUnion<'ACTIVE' | 'ERROR' | 'DECOMMISSIONING' | 'DEGRADED' | 'HIBERNATED' | 'HIBERNATING' | 'INITIALIZING' | 'MAINTENANCE' | 'PARKED' | 'PARKING' | 'PENDING' | 'PREPARED' | 'PREPARING' | 'RESIZING' | 'RESUMING' | 'TERMINATED' | 'TERMINATING' | 'UNKNOWN' | 'UNPARKING' | 'SYNCHRONIZING' | 'ASSOCIATING'>;
...
declare type ConvertColumnTypes<Cols extends CreateTableColumnDefinitions, Converted extends Record<keyof Cols, unknown>, PK extends SomeRow = ConvertPrimaryKeyType<any, any>> = {
...
declare type ConvertColumnTypesImpl<Columns extends CreateTableColumnDefinitions, Overrides extends TableSchemaInferenceOverrides> = {
...
declare type ConvertPrimaryKeyType<FullDef extends CreateTableDefinition, Converted extends Record<keyof FullDef['columns'], unknown>, PK extends FullCreateTablePrimaryKeyDefinition<any> = NormalizePK<FullDef['primaryKey']>> = Normalize<{
...
declare interface CqlCollectionTypeMap<Def, TypeOverrides extends TableSchemaInferenceOverrides['typeOverrides']> {
...
declare type CqlListType2TsType<Def, TypeOverrides extends TableSchemaInferenceOverrides['typeOverrides']> = Def extends {
    valueType: infer ValueType extends string | {
        type: 'userDefined';
    };
} ? (CqlType2TSTypeInternal<NormalizeTypeFormat<ValueType>, ValueType, TypeOverrides> & {})[] : TypeErr<`Invalid definition for 'list'; should be of format { type: 'list', valueType: <scalar> | <udt> }`>;

declare type CqlMapType2TsType<Def, TypeOverrides extends TableSchemaInferenceOverrides['typeOverrides']> = Def extends {
    keyType: infer KeyType extends string;
    valueType: infer ValueType extends string | {
        type: 'userDefined';
    };
} ? Map<CqlType2TSTypeInternal<KeyType, never, TypeOverrides> & {}, CqlType2TSTypeInternal<NormalizeTypeFormat<ValueType>, ValueType, TypeOverrides> & {}> : TypeErr<`Invalid definition for 'map'; should be of format { type: 'map', keyType: <scalar>, valueType: <scalar> | <udt> }`>;

declare interface CqlScalarTypeMap {
    ascii: string | null;
    bigint: bigint | null;
...
declare type CqlSetType2TsType<Def, TypeOverrides extends TableSchemaInferenceOverrides['typeOverrides']> = Def extends {
    valueType: infer ValueType extends string | {
        type: 'userDefined';
    };
} ? Set<CqlType2TSTypeInternal<NormalizeTypeFormat<ValueType>, ValueType, TypeOverrides> & {}> : TypeErr<`Invalid definition for 'set'; should be of format { type: 'set', valueType: <scalar> | <udt> }`>;

declare type CqlType2TSTypeInternal<Type, Def, TypeOverrides extends TableSchemaInferenceOverrides['typeOverrides']> = Type extends keyof TypeOverrides ? TypeOverrides[Type] : Type extends keyof CqlScalarTypeMap ? CqlScalarTypeMap[Type] : Type extends keyof CqlCollectionTypeMap<Def, TypeOverrides> ? CqlCollectionTypeMap<Def, TypeOverrides>[Type] : unknown;

declare type CqlUserDefinedType2TsType<Def, TypeOverrides extends TableSchemaInferenceOverrides['typeOverrides']> = Def extends {
    udtName: infer UDTName extends string;
} ? UDTName extends keyof TypeOverrides ? TypeOverrides[UDTName] : SomeRow : TypeErr<`Invalid definition for 'userDefined'; should be of format { type: 'userDefined', udtName: '<name>' }`>;
 ...
 * @public
 */
export declare interface CreateTypeDefinition {
    /**
 ...
 * @public
 */
export declare interface CreateTypeOptions extends CommandOptions<{
    timeout: 'tableAdminTimeoutMs';
}>, WithKeyspace {
    /**
 ...
 * @public
 */
export declare type DataAPICreatableScalarTypes = Exclude<keyof CqlScalarTypeMap, 'counter' | 'timeuuid' | 'varchar'>;
 ...
 * @public
 */
export declare type DataAPIType2TSType<Def extends CreateTableColumnDefinitions[string], TypeOverrides extends TableSchemaInferenceOverrides['typeOverrides'] = Record<never, never>> = CqlType2TSTypeInternal<NormalizeTypeFormat<Def>, Def, TypeOverrides>;
 ...
 * @public
 */
export declare type DataAPITypes = keyof CqlScalarTypeMap | keyof CqlCollectionTypeMap<any, any>;
 ...
 * @public
 */
export declare interface DropTypeOptions extends CommandOptions<{
    timeout: 'tableAdminTimeoutMs';
}>, WithKeyspace {
    /**
 ...
 * @public
 */
export declare interface EmbeddingProviderModelApiSupportInfo {
    /**
 ...
 * @public
 */
export declare interface FindEmbeddingProvidersOptions extends CommandOptions<{
    timeout: 'databaseAdminTimeoutMs';
}> {
    /**
 ...
 * @public
 */
export declare interface FindRerankingProvidersOptions extends CommandOptions<{
    timeout: 'databaseAdminTimeoutMs';
}> {
    /**
     * Filter models by their lifecycle status.
...
declare type InferSchemaFromDefinition<FullDef extends CreateTableDefinition<FullDef>, Overrides extends TableSchemaInferenceOverrides, Converted extends Record<keyof FullDef['columns'], unknown> = ConvertColumnTypesImpl<FullDef['columns'], Overrides>> = Normalize<ConvertColumnTypes<FullDef['columns'], Converted, ConvertPrimaryKeyType<FullDef, Converted>>>;

declare type InferTablePKFromDefinition<FullDef extends CreateTableDefinition<FullDef>, Overrides extends TableSchemaInferenceOverrides> = Normalize<ConvertPrimaryKeyType<FullDef, ConvertColumnTypesImpl<FullDef['columns'], Overrides>>>;
...
export declare type InferUDTSchema<Def extends CreateTypeDefinition, Overrides extends UDTSchemaInferenceOverrides = Record<never, never>> = {
 ...
 * @public
 */
export declare const LIB_VERSION = "2.2.1";
 ...
 * @public
 */
export declare interface ListIndexOptions extends CommandOptions<{
    timeout: 'tableAdminTimeoutMs';
}>, WithKeyspace {
    /**
 ...
 * @public
 */
export declare interface ListTypeDefinition {
    /**
 ...
 * @public
 */
export declare interface ListTypesOptions extends CommandOptions<{
    timeout: 'tableAdminTimeoutMs';
}>, WithKeyspace {
    /**
 ...
 * @public
 */
export declare type LooseCreateTableColumnDefinition = LitUnion<DataAPICreatableScalarTypes>;
 ...
 * @public
 */
export declare type LooseCreateTypeFieldDefinition = LitUnion<DataAPICreatableScalarTypes>;
 ...
 * @public
 */
declare type ModelLifecycleStatus = 'SUPPORTED' | 'DEPRECATED' | 'END_OF_LIFE';
...
declare type NormalizeTypeFormat<Def> = Def extends {
    type: infer Type;
} ? Type : Def;
...
/* Excluded from this release type: ParsedSerDesConfig */

/* Excluded from this release type: ParsedTimeoutDescriptor */
 ...
 * @public
 */
export declare interface RenameFieldOperation<Schema extends SomeRow> {
    /**
 ...
 * @public
 */
export declare interface RerankingProviderAuthInfo {
    /**
     * Whether this method of auth is supported for the provider.
     */
    enabled: boolean;
 ...
 * @public
 */
export declare interface RerankingProviderInfo {
    /**
     * The prettified name of the provider (as shown in the Astra portal).
     *
     * @example
 ...
 * @public
 */
export declare interface RerankingProviderModelApiSupportInfo {
    /**
     * The current lifecycle status of the model.
     *
     * @example
 ...
 * @public
 */
export declare interface RerankingProviderModelInfo {
    /**
     * The name of the model to use.
     *
     * @example
 ...
 * @public
 */
export declare interface RerankingProviderTokenInfo {
    /**
     * The accepted token.
     *
...
export declare type ResolveUDTSchema<DefOrSchema extends SomeRow> = DefOrSchema extends CreateTypeDefinition ? InferUDTSchema<DefOrSchema> : DefOrSchema;
 ...
 * @public
 */
export declare type StrictCreateTableColumnDefinition = TableScalarColumnDefinition | TableMapColumnDefinition | TableListColumnDefinition | TableSetColumnDefinition | TableVectorColumnDefinition | TableUserDefinedTypeColumnDefinition;
 ...
 * @public
 */
export declare type StrictCreateTypeFieldDefinition = TableScalarColumnDefinition;
 ...
 * @public
 */
export declare type TableIndexColumn<WSchema> = keyof WSchema | Partial<Record<(keyof WSchema & string), '$keys' | '$values'>>;
 ...
 * @public
 */
export declare type TableIndexDescriptor = (TableRegularIndexDescriptor | TableTextIndexDescriptor | TableVectorIndexDescriptor | TableUnknownIndexDescriptor) & ({
    name: string;
});
 ...
 * @public
 */
export declare type TablePullAll<Schema> = CollectionArrayUpdate<Schema>;
 ...
 * @public
 */
export declare type TablePush<Schema> = CollectionPush<Schema>;
 ...
 * @public
 */
export declare interface TableRegularIndexDescriptor {
    indexType: 'regular';
 ...
 * @public
 */
export declare interface TableSchemaInferenceOverrides {
 ...
 * @public
 */
export declare interface TableTextIndexDescriptor {
    indexType: 'text';
    column: TableIndexColumn<SomeRow>;
 ...
 * @public
 */
export declare interface TableUnknownIndexDescriptor {
    indexType: 'UNKNOWN';
    column: 'UNKNOWN';
    definition: {
        apiSupport: {
 ...
 * @public
 */
export declare interface TableUnsupportedColumnApiSupport {
    createTable: boolean;
    insert: boolean;
    read: boolean;
    filter: boolean;
...
export declare interface TableUserDefinedTypeColumnDefinition {
    type: 'userDefined';
    udtName: string;
}
 ...
 * @public
 */
export declare interface TableVectorIndexDescriptor {
    indexType: 'vector';
    column: TableIndexColumn<SomeRow>;
...
export declare interface UDTSchemaInferenceOverrides {
    typeOverrides?: Partial<Record<LitUnion<DataAPITypes>, unknown>>;
